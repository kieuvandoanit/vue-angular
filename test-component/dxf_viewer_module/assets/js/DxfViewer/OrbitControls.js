...
export const OrbitControls = function (object, domElement) {
  ...
  this.SetState = function ({ target, position, zoom }) {
  ...
  function handleTouchMoveDolly(event) {
    ...
    const canvas = scope.domElement.getBoundingClientRect();
    const mx = maxx - Math.abs(dx / 2);
    const my = maxy - Math.abs(dy / 2);
    const zoomCenter = new THREE.Vector2(mx - canvas.left, my - canvas.top);
